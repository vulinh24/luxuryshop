...
INSERT INTO `banner` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `description`, `name`, `url`,
                      `url_img`)
VALUES (3, 2, '2021-11-13 16:10:39.000000', NULL, NULL, 'Thiết kế sang trọng sẽ mang đến cho bạn trải nghiệm tốt nhất!',
        'Sản phẩm hoàn hiện tới từng chi tiết', '#', 'main_banner.jpg'),
       (7, 2, '2021-11-16 09:59:06.000000', NULL, NULL, 'Thiết kế đột phá trong trải nghiệm người dùng!',
        'Bộ sưu tập mới Elegance', '#', 'banner1.jpg');
...
INSERT INTO `blog` (`id`, `description`, `image`, `title`)
VALUES (1,
        'Phong cách thiết kế hiện đại là sự đoạn tuyệt với phong cách thiết kế cổ điển. Ở phong cách này cách thiết kế và bố trí nội thất được lược bỏ những chi tiết rườm rà và phi đối xứng.',
        'pk-hien-dai.jpg', 'Phong cách thiết kế nội thất hiện đại'),
       (2,
        'Đây là một trong các phong cách thiết kế nội thất được ưa chuộng nhất hiện nay. Điểm nổi bật của phong cách này chính là sự đơn giản, tinh tế và không kém phần sang trọng, hiện đại. Ở phong cách này, chúng ta có thể thấy những chi tiết phụ được tiết chế.',
        'pk-toi-gian-1.jpg', 'Phong cách thiết kế nội thất tối giản (Minimalist)'),
       (3,
        'Qua bao nhiêu năm, dù dòng chảy thời gian có làm thay đổi tất cả mọi thứ nhưng sức hút của phong cách thiết kế nội thất cổ điển vẫn chưa hề có dấu hiệu giảm nhiệt. Cổ điển là phong cách trái ngược hoàn toàn với phong cách hiện đại.',
        'pk-co-dien.jpg', 'Phong cách thiết kế cổ điển'),
       (4,
        'Nói tới những phong cách thiết kế nội thất thịnh hành nhất trên thế giới thì không thể bỏ qua phong cách Retro. Vào những năm 50 – 70 của TK trước, phong cách thiết kế nội thất Retro đã “làm mưa làm gió” trong ngành thiết kế. Tới thời điểm hiện tại, sức hút của phong cách này vẫn vẹn nguyên như ngày nào khi chúng xuất hiện ở rất nhiều gia đình, khu giải trí, khách sạn, quán café,…',
        'pk-phong-cach-retro.jpg', 'Phong cách thiết kế nội thất Retro'),
       (5,
        'Cái tên tiếp theo trong danh sách các phong cách thiết kế nội thất HOT nhất hiện nay chính là Scandinavian. Phong cách này thể hiện sự sang trọng, tinh tế.',
        'pk-bac-au.jpg', 'Phong cách thiết kế Scandinavian (Bắc Âu)'),
       (6,
        'Phong cách Hitech chủ yếu sử dụng các thiết bị, đồ dùng, vật liệu hiện đại, các ứng dụng công nghệ tiên tiến trong không gian kiến trúc, nội thất. Không chỉ mang đến vẻ đẹp hiện đại, tiện nghi, phong cách Hitech còn góp phần nâng cao chất lượng sống của con người.',
        'pk-hitech.jpg', 'Ấn tượng cùng phong cách thiết kế Hi-Tech'),
       (7,
        'Phong cách thiết kế nội thất đương đại tập trung vào không gian sử dụng. Rất dễ nhận thấy rằng các thành phần kiến trúc của phong cách này rất đơn giản, chủ yếu là các mảng tường, khối thay vì chi tiết cầu kỳ, rườm rà. Vật liệu được sử dụng phổ biến trong phong cách nội thất đương đại là gỗ, ốp da hoặc vải.',
        'pk-duong-dai-1.jpg', 'Phong cách thiết kế nội thất đương đại'),
       (8,
        'Trong thiết kế nội thất, phong cách Vintage chính là sự pha trộn của những thiết bị hiện đại như máy tính, đồ gia dụng, đèn trang trí,… kết hợp cùng với những món đồ đã cũ kỹ như bàn ghế tróc sơn, những khung ảnh, chùm đèn cổ.',
        'pk-phong-cach-vintage.jpg', 'Phong cách thiết kế nội thất Vintage'),
       (9,
        'Trong phong cách thiết kế nội thất luxury, tất cả các đồ nội thất đều được chọn lựa từ những thứ cao cấp nhất. Không phô trương, hào nhoáng quá mức ở bề ngoài, mà vẻ đẹp của phong cách luxury còn được thể hiện ở những giá trị cốt lõi bên trong.',
        'phong-khach-luxury.jpg', 'Sang trọng với phong cách thiết kế nội thất Luxury');
...
INSERT INTO `category` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `description`, `name`, `seo`)
VALUES (1, NULL, NULL, 2, '2021-11-15 16:41:23.000000', 'các loại bàn ghế sofa', 'Sofa', 'sofa-1636969283335'),
       ...
       (6, NULL, NULL, 2, '2021-11-13 08:54:17.000000', 'tượng trang trí', 'Tượng Trang Trí',
        'tuong-trang-tri-1636768457107'),
       (7, NULL, NULL, 2, '2021-11-13 08:54:20.000000', 'tranh treo tường', 'Tranh Ảnh', 'tranh-anh-1636768460458'),
       (8, NULL, NULL, 2, '2021-11-13 08:54:23.000000', 'đèn học, đèn phòng khách,..', 'Đèn Trang Trí',
        'en-trang-tri-1636768463735'),
       (9, NULL, NULL, 2, '2021-11-13 08:54:26.000000', 'các loại lọ trang trí', 'Lọ Trang Trí',
        'lo-trang-tri-1636768466914'),
...
INSERT INTO `collection` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `description`, `name`,
                          `seo`)
VALUES (1, NULL, '2021-11-01 13:56:39.000000', NULL, NULL, 'bộ sưu tập phòng khách', 'Bộ Sưu Tập Phòng Khách',
        'bo_suu_tap_phong_khach'),
       (2, NULL, '2021-11-01 13:56:39.000000', NULL, NULL, 'bộ sưu tập phòng ăn', 'Bộ Sưu Tập Phòng Ăn',
        'bo_suu_tap_phong_an'),
       (3, NULL, '2021-11-01 13:56:39.000000', NULL, NULL, 'bộ sưu tập phòng ngủ', 'Bộ Sưu Tập Phòng Ngủ',
        'bo_suu_tap_phong_ngu'),
       (4, NULL, '2021-11-01 13:56:39.000000', NULL, NULL, 'bộ sưu tập trang trí và gia dụng', 'Trang Trí Và Gia Dụng',
        'trang_tri_va_gia_dung');
...
(
    ...
    `is_replied`   bit(1)      NOT NULL DEFAULT b'0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `contact` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `email`, `message`, `name`,
                       `is_replied`)
VALUES (11, NULL, NULL, NULL, NULL, 'admin@gmail.com', NULL, NULL, b'0'),
       (12, NULL, NULL, NULL, NULL, 'ah@gmail.com', NULL, NULL, b'1'),
       (13, NULL, NULL, NULL, NULL, 'ah@gmail.com', NULL, NULL, b'1');
...
INSERT INTO `discount` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `discount`, `name`)
VALUES (1, NULL, NULL, NULL, NULL, 0.1, 'HAPPYLIFE');
...
INSERT INTO `order_detail` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `code`,
                            `customer_address`, `customer_email`, `customer_name`, `customer_note`, `customer_phone`,
                            `isCancel`, `status`, `total`, `total_received`, `user_id`)
VALUES (4, NULL, '2022-10-03 10:30:42.000000', NULL, '2022-10-03 10:38:42.000000', 'happylife', 'a', 'a', 'a', 'a', 'a',
        b'1', 'Đã hủy', 107766000, 107766000, NULL),
       (5, NULL, '2022-10-03 10:34:30.000000', NULL, '2022-10-03 10:38:41.000000', 'happylife', 'a', 'a', 'a', 'a', 'a',
        b'0', 'Đang giao hàng', 212877000, 212877000, NULL),
       (6, NULL, '2022-10-03 11:24:45.000000', NULL, '2022-10-03 11:28:37.000000', NULL, 'a', 'admin@gmail.com',
        'admin', 'a', 'a', b'1', 'Đã hủy', 300090000, 300090000, 12),
       (7, NULL, '2022-10-03 11:31:58.000000', NULL, '2022-10-05 14:23:39.000000', 'happylife', 'a', 'a', 'a', 'a', 'a',
        b'1', 'Đã hủy', 165042000, 165042000, NULL),
       (8, NULL, '2022-10-03 11:32:54.000000', NULL, '2022-10-03 11:34:44.000000', NULL, 'a', 'admin@gmail.com',
        'admin', 'a', 'a', b'1', 'Đã hủy', 223170000, 223170000, 12),
       (9, NULL, '2022-10-03 16:13:27.000000', NULL, '2022-10-03 16:13:57.000000', 'happylife', 'Hà Nội',
        'vulinhzh@gmail.com', 'Linh Vũ', '', '1234567890', b'0', 'Đang giao hàng', 224982000, 224982000, 21),
       (10, NULL, '2022-10-03 16:38:25.000000', NULL, NULL, NULL, 'Hà Nội', 'vulinhzh@gmail.com', 'Vũ Anh Linh', '',
        '1234567890', b'0', 'Chờ xác nhận', 85690000, 85690000, 22);
...
INSERT INTO `order_product` (`id`, `product_price`, `product_title`, `quantity`, `order_id`, `sold_date`, `product_id`)
VALUES (7, 53883000, 'Sofa da Cascadia', 2, 4, '2022-10-03', -1),
       (8, 62937000, 'Sofa da Italia Impressive', 1, 5, '2022-10-03', 4),
       (9, 149940000, 'Sofa da Italia Zoe 3 chỗ', 1, 5, '2022-10-03', 8),
       (10, 74390000, 'Sofa da Elise', 3, 6, '2022-10-03', 2),
       (11, 76920000, 'Sofa da Waldo', 1, 6, '2022-10-03', 3),
       (12, 66951000, 'Sofa da Elise', 2, 7, '2022-10-03', 2),
       (13, 31140000, 'Sofa vải Alassa', 1, 7, '2022-10-03', 11),
       (14, 74390000, 'Sofa da Elise', 3, 8, '2022-10-03', 2),
       (15, 66951000, 'Sofa da Elise', 2, 9, '2022-10-03', 2),
       (16, 91080000, 'Sofa da Italia Impressive 2', 1, 9, '2022-10-03', 5),
       (17, 74390000, 'Sofa da Elise', 1, 10, '2022-10-03', 2),
       (18, 11300000, 'Ghế thư giãn Nicky', 1, 10, '2022-10-03', 19);
...
INSERT INTO `product_detail` (`id`, `dimension`, `insurance`, `material`, `origin`, `product_id`)
VALUES (1, '270x107x72', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật full-grain 100%, khung gỗ, chân kim loại mạ crom', 'Khác', 1),
       (2, '280x182x94', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật full-grain 100%, khung gỗ, chân kim loại mạ crom', 'Khác', 2),
       (3, '290x183x95', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật full-grain 100%, khung gỗ, chân kim loại mạ crom', 'Khác', 3),
       (4, '217x107x68 - 217x107x82', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật top grain 100%, khung gỗ', 'Khác', 4),
       (5, '300x148x88', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật top grain 100%, khung gỗ', 'Italia', 5),
       (6, '290x204x100', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật top grain 100%, khung gỗ, chân inox', 'Italia', 6),
       (7, '284x230x90', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật top grain 100%, khung gỗ, chân crom', 'Italia', 7),
       (8, '240x102x67 - 240x102x97', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Da thật 100%, khung gỗ, chân kim loại', 'Italia', 8),
       (9, '268x86x81', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Khung gỗ, nhồi đệm kết hợp lò xo, bọc vải, chân kim loại', 'Khác', 9),
       (10, '266x89x83', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Khung gỗ, nhồi đệm kết hợp lò xo, bọc vải, chân kim loại', 'Mỹ', 10),
       (11, ' 280x166x91', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Khung gỗ, nhồi đệm kết hợp lò xo, bọc vải, chân kim loại', 'Úc', 11),
       (12, '212x148x70', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Khung gỗ, nhồi đệm kết hợp lò xo, bọc vải, chân kim loại', 'Mỹ', 12),
       (13, '265x150x84', 'Bảo hành 10 năm cho khung, 2 năm cho phần da. Bảo dưỡng miễn phí 6 tháng/lần',
        'Khung gỗ, nhồi đệm kết hợp lò xo, bọc vải, chân kim loại', 'Châu Âu', 13),
...
INSERT INTO `product_image` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `path`, `title`,
                             `product_id`)
VALUES (1, NULL, NULL, NULL, NULL, 'DSC7754.jpg', '', 1),
...
INSERT INTO `role` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `description`, `name`)
...
INSERT INTO `user` (`id`, `created_by`, `created_date`, `updated_by`, `updated_date`, `address`, `email`, `name`,
                    `password`, `phone`, `username`)
VALUES (12, NULL, NULL, NULL, NULL, NULL, 'admin@gmail.com', 'admin',
        '$2a$10$ZfKs92OHmy1ZPBGfc5ekmuxaTYt97tiRBtm39C6QE3.PEL2yTmZVy', NULL, 'admin'),
       (13, NULL, NULL, NULL, '2022-10-03 11:36:56.000000', 'ha noi', 'vulinhzh@gmail.com', 'Linh Vu',
        '$2a$10$HxIKaJazYrWb.jwDvq1k9eB55sptnmc.o/b1NDUNZgIbmMCgpnwyy', '1234567890', 'linhvu'),
       (15, NULL, NULL, NULL, NULL, NULL, 'admin2@gmail.com', 'admin 2',
        '$2a$10$FG0c7wvgLifZtCwFx0Xlb.gsV27Us9N8E5stjPUbk71N0lAi6OKkG', NULL, 'operator'),
       (16, NULL, '2022-10-03 10:37:27.000000', NULL, NULL, NULL, 'test@test', 'test',
        '$2a$10$O2aEryEECSZlVU8oBrpsmO8H1yf5BF5orrhCIlyoepFmzB8DycZ.6', NULL, 'test_user'),
       (21, NULL, NULL, NULL, '2022-10-03 16:13:05.000000', 'Hà Nội', 'vulinhzh@gmail.com', 'Linh Vũ', 'social-0',
        '1234567890', '3327555430898420'),
       (22, NULL, NULL, NULL, '2022-10-03 16:38:19.000000', 'Hà Nội', 'vulinhzh@gmail.com', 'Vũ Anh Linh', 'social-1',
        '1234567890', '107677967143584566098');
...
ALTER TABLE `favorite_product`
    ADD KEY `FKt7xfkw91alk18wbdo0n7kc4n7` (`product_id`),
  ADD KEY `FK77loqyqxss454wdhhyhuatyfx` (`user_id`);
...
ALTER TABLE `order_detail`
    ADD PRIMARY KEY (`id`),
  ADD KEY `FKh20tda8lta71exaxpumnxee9r` (`user_id`);
...
ALTER TABLE `order_product`
    ADD PRIMARY KEY (`id`),
  ADD KEY `FKafpwpn0qp1cm08lobp0kie45x` (`order_id`);
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `FKm8yjhy167e7fp8b4yk7ey1m5p` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `favorite_product`
--
ALTER TABLE `favorite_product`
    ADD CONSTRAINT `FK77loqyqxss454wdhhyhuatyfx` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `FKt7xfkw91alk18wbdo0n7kc4n7` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `order_detail`
--
ALTER TABLE `order_detail`
    ADD CONSTRAINT `FKh20tda8lta71exaxpumnxee9r` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `order_product`
--
ALTER TABLE `order_product`
    ADD CONSTRAINT `FKafpwpn0qp1cm08lobp0kie45x` FOREIGN KEY (`order_id`) REFERENCES `order_detail` (`id`);

--
-- Constraints for table `product`
--
ALTER TABLE `product`
    ADD CONSTRAINT `FKeycgbvdy2b1j7f2k809rghvgm` FOREIGN KEY (`collection_id`) REFERENCES `collection` (`id`),
  ADD CONSTRAINT `FKs48eyewaihty5qbemlxqa27x4` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);

--
-- Constraints for table `product_detail`
--
ALTER TABLE `product_detail`
    ADD CONSTRAINT `FK1curd4ewvw1x0ug4l518jqoje` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `product_image`
--
ALTER TABLE `product_image`
    ADD CONSTRAINT `FKjac7pn534bktj4tvkxqvydglf` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Constraints for table `rate_product`
--
ALTER TABLE `rate_product`
    ADD CONSTRAINT `FK52wjv3sypeh9bfkwxsra231mb` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`),
  ADD CONSTRAINT `FKfas7bufrobyx8kbqlou2i409d` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `user_role`
--
ALTER TABLE `user_role`
    ADD CONSTRAINT `FK6ms0gxqvjxkgul0vim4h7rsme` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
