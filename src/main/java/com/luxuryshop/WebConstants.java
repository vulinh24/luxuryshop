...
public class WebConstants {
	 ...
	 */
	public static final String MY_MAIL = "changtrai242001@gmail.com";
	...
	public static final String ORDER_EMAIL_1 = "<table style=\"border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #eeeeee;width:100%\" cellpadding=\"0\" cellspacing=\"0\">\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 14px; line-height: 19.6px;\">LUXURY SHOP</span></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 30px; line-height: 42px;\">Đơn hàng đã được xác nhận!</span></strong></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 170%; text-align: center;\"><span style=\"font-size: 16px; line-height: 27.2px;\">Cảm ơn bạn đã lựa chọn sản phẩm ở Luxury Shop. Chúng tôi sẽ đóng gói và vận chuyển đơn hàng tới bạn nhanh nhất có thể!</span></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 14px; line-height: 19.6px;\">HÓA ĐƠN</span></strong></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 14px; line-height: 19.6px;\">[ID]</span></strong></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t</div>\n" +
			"  </div>";
	public static final String ORDER_EMAIL_3 = "<div class=\"u-row-container\" style=\"padding: 0px;background-color: transparent\">\n" +
			"\t<div class=\"u-row\" style=\"Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;\">\n" +
			"\t  <div style=\"border-collapse: collapse;display: table;width: 100%;background-color: transparent;\">\n" +
			"\t\t<!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding: 0px;background-color: transparent;\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width:600px;\"><tr style=\"background-color: #ffffff;\"><![endif]-->\n" +
			"\t\t\n" +
			...
			"\t\t  \n" +
			"\t<div class=\"v-text-align\" style=\"color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 14px; line-height: 19.6px;\">Tổng cộng</span></strong></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 14px; line-height: 19.6px;\">Địa chỉ giao hàng:</span></strong></p>\n" +
			...
			"\t\t  \n" +
			"\t<div class=\"v-text-align\" style=\"color: #5c5757; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 14px; line-height: 19.6px;\">Số điện thoại:</span></strong></p>\n" +
			"  <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 14px; line-height: 19.6px;\">[PHONE]</span></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><strong><span style=\"font-size: 30px; line-height: 42px;\">Luxury Shop</span></strong></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t\t  \n" +
			"\t<div class=\"v-text-align\" style=\"color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;\">\n" +
			"\t  <p style=\"font-size: 14px; line-height: 170%; text-align: center;\"><em><span style=\"font-size: 14px; line-height: 23.8px;\">Luôn mang đến bạn sản phẩm chất lượng tốt nhất!</span></em></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t  <p style=\"font-size: 14px; line-height: 140%;\">©Luxury Shop. All Rights Reserved</p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t</tbody>\n" +
			"\t</table>";
	public static final String ORDER_EMAIL_2 = "<div class=\"u-row-container\" style=\"padding: 0px;background-color: transparent\">\n" +
			"\t<div class=\"u-row no-stack\" style=\"Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ffffff;\">\n" +
			"\t  <div style=\"border-collapse: collapse;display: table;width: 100%;background-color: transparent;\">\n" +
			"\t\t<!--[if (mso)|(IE)]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td style=\"padding: 0px;background-color: transparent;\" align=\"center\"><table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"width:600px;\"><tr style=\"background-color: #ffffff;\"><![endif]-->\n" +
			"\t\t\n" +
			...
			"\t\t  \n" +
			"\t<div class=\"v-text-align\" style=\"color: #615e5e; line-height: 140%; text-align: left; word-wrap: break-word;\">\n" +
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 14px; line-height: 19.6px;\">[TITLE]</span></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
			...
			"\t\t  \n" +
			"\t<div class=\"v-text-align\" style=\"color: #615e5e; line-height: 140%; text-align: right; word-wrap: break-word;\">\n" +
			"\t  <p style=\"font-size: 14px; line-height: 140%;\"><span style=\"font-size: 14px; line-height: 19.6px;\">[SL] x [PRICE]</span></p>\n" +
			"\t</div>\n" +
			"  \n" +
			"\t\t</td>\n" +
			"\t  </tr>\n" +
